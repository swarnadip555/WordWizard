        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#/" className={`transition-colors hover:underline ${isDark ? 'hover:text-blue-400' : 'hover:text-blue-600'}`}>
                  {t("footer.home")}
                </a>
              </li>
              <li>
                <a href="#/about" className={`transition-colors hover:underline ${isDark ? 'hover:text-blue-400' : 'hover:text-blue-600'}`}>
                  {t("footer.about")}
                </a>
              </li>
              <li>
                <button 
                  onClick={scrollToTop}
                  className={`transition-colors hover:underline flex items-center gap-1 ${isDark ? 'hover:text-blue-400' : 'hover:text-blue-600'}`}
                >
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className={`transition-all hover:scale-110 active:scale-95 ${isDark ? 'hover:text-blue-400' : 'hover:text-blue-600'}`}
        ...
        <div className={`pt-6 border-t text-sm text-center ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
          <p className="flex items-center justify-center gap-1 flex-wrap">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`font-semibold transition-colors ${isDark ? 'hover:text-blue-400' : 'hover:text-blue-600'}`}
            >
              Palchhin
            </a>
          </p>
