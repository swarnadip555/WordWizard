...
const Navbar = (props) => {
  ...
  const allThemes = [
    ...
    { 
      id: 'ocean', 
      name: 'Deep Ocean', 
      gradient: 'linear-gradient(135deg, #0a192f 0%, #1e3a5f 50%, #2d5a7b 100%)',
    ...
    { 
      id: 'royal', 
      name: 'Royal Purple', 
      gradient: 'linear-gradient(135deg, #2e1065 0%, #4c1d95 50%, #6b21a8 100%)',
    ...
    { 
      id: 'light', 
      name: 'Cloud White', 
      gradient: 'linear-gradient(135deg, #ffffff 0%, #f3f4f6 50%, #e5e7eb 100%)',
    ...
    { 
      id: 'aurora', 
      name: 'Aurora', 
      gradient: 'linear-gradient(135deg, #1e1b4b 0%, #312e81 40%, #3730a3 70%, #1e3a8a 100%)',
    ...
    { 
      id: 'cyberpunk', 
      name: 'Cyberpunk', 
      gradient: 'linear-gradient(135deg, #0f172a 0%, #1e293b 40%, #334155 70%, #475569 100%)',
    ...
    { 
      id: 'sunset-blaze', 
      name: 'Sunset Blaze', 
      gradient: 'linear-gradient(135deg, #431407 0%, #7c2d12 40%, #9a3412 70%, #c2410c 100%)',
  ...
  const currentTheme = allThemes.find(t => t.id === props.currentThemeId) || allThemes[0];
  const isDark = currentTheme.category === 'dark' || currentTheme.category === 'vibrant';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center flex-shrink-0 mr-6">
        <Link className="font-bold text-xl tracking-tight hover:text-blue-500 transition-colors" to="/">
      ...
      <div className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto ${menuOpen ? 'block' : 'hidden'} lg:block`}>
        ...
        <div className="mt-4 lg:mt-0">
          <div className="relative" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              <div className={`absolute right-0 mt-2 w-72 rounded-xl shadow-2xl overflow-hidden z-50 animate-fadeIn ${
                ...
                <div className="max-h-96 overflow-y-auto">
                  ...
                  {groupedThemes.dark.map((theme) => {
                    ...
                    return (
                      ...
                      >
                        <div 
                          className={`w-8 h-8 rounded-lg bg-gradient-to-br ${theme.preview} border ${
